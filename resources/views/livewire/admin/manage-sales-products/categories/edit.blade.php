<div>
    <div class="container-fluid">
        ...
        <h1>Edit Sales Collection - Category</h1>
        <form>
            ...
            <select class="form-control" wire:model.defer="type" name="type" id="type">
            ...
            <input type="button" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="updateCategory({{$categories->id}})" value="Update">
        </form>
