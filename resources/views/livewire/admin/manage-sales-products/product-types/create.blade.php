<div>
    <div class="container-fluid">
        ...
        <h1>Create Sales Collection - Product Type</h1>
        <form>
...
{{--                      placeholder="Content"></textarea>--}}
            ...
            <input type="button" id="create" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="createNewProductType" value="Create">
        </form>
