<div class="container-fluid">
    ...
    <h1>Edit Sales Collection - Product Type</h1>
    <form>
        ...
        <div class="form-floating mb-3">
            <textarea class="form-control" id="content" wire:model.defer="content" type="text" name="contents"
        ...
        <div class="form-group mb-3">
            ...
            <input class="form-control" wire:model="meta_description" id="title" type="text"
        ...
        <input type="button" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="updateProductTypes({{$product_types->id}})"
               value="Update">
    </form>
