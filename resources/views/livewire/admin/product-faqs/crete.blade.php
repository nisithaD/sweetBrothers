<div>
    <h1>Create Product FAQ</h1>
    <label for="title">Title</label>
    <div class="form-floating mb-3">
        <input class="form-control" wire:model.defer="input.title" id="title" type="text" name="title"
               placeholder="Title"/>
    ...
    <input type="button" id="create" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="createFAQ" value="Create">
