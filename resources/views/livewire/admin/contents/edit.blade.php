<div class="container-fluid">
    ...
    <h1>Edit content</h1>
    <form wire:submit.prevent="updateContentData">
        ...
        <div class="form-floating mb-3">
            <textarea class="form-control" id="content" wire:model.defer="contents" type="text" name="content"
                      placeholder="Title">{{$contents}}</textarea>
        </div>
        ...
        @endif
        <br>
        <input type="submit" class="btn btn-primary ml-auto mr-auto mt-5" value="Update">
    </form>
