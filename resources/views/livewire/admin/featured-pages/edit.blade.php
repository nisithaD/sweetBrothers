<div>
    <div class="container-fluid">
        ...
        <form>
            ...
            <div class="form-floating mb-3">
                <input class="form-control" wire:model.defer="link" id="link" type="text" name="link" placeholder="Link"/>
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" wire:model.defer="meta_title" id="title" type="text" name="meta_title"
                       placeholder="Meta title"/>
            </div>

            <div class="form-group mb-3">
                {!! Form::label('meta_description', 'Meta Description:') !!}
                <input class="form-control" wire:model.defer="meta_description" id="title" type="text" name="meta_description"
                       placeholder="Meta Description"/>
            </div>

            <div class="form-group mb-3">
                {!! Form::label('meta_keywords', 'Meta Keywords:') !!}
                <input class="form-control" wire:model.defer="meta_keywords" id="title" type="text" name="meta_keywords"
                       placeholder="Meta Keywords"/>
            </div>
            <input type="button" id="create" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="editFeaturedPage({{$featured_pages->id}})" value="Update">
        </form>
