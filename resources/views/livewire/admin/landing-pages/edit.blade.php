<div class="container-fluid">
    ...
    <form>
        ...
        <div class="form-floating mb-3">
            <input class="form-control" wire:model="page_url" id="page_url" type="text" name="page_url"
        ...
        <br>
        <input type="button" class="btn btn-primary ml-auto mr-auto mt-5" wire:click="updateLandingPage" value="Update">
    </form>
