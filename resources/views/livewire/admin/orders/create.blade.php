        ...
        <div class="row">
                ...
                @else
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid" placeholder="Pick a first payment date"
                               id="firstpaymentdate" wire:model.lazy="firstpaymentdate" name="firstpaymentdate"/>
                    </div>
                    <div class="form-group">
                ...
                @else
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-solid" placeholder="Pick a second payment date"
                               id="secondpaymentdate" wire:model.lazy="secondpaymentdate" name="secondpaymentdate"/>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-sm-6 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" wire:model.defer="input.venuesname" id="venuesname" type="text" name="venuesname"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" wire:model.defer="input.totalhire" id="totalhire" type="text" name="totalhire"
                           placeholder="Total Hire"/>
                </div>
                <div class="form-group">
                    {!! Form::label('pdfFile', 'PDF File Upload:') !!}
                    <input type="file" name="pdf_file" wire:model.defer="pdfFile">
