                ...
                <tr>
                  <td>
                    ...
                    <p style="width: 100%; display: inline-block; margin-bottom: 10px; margin-top: 0;">
                      <span style="display: inline-block; width: 100%">You referred a customer to us with order number “@if(isset($cmp_fname)){{$cmp_fname}}@endif”. </span>
                    </p>
                    <p style="width: 100%; display: inline-block; margin-bottom: 10px; margin-top: 0;">
                      <span style="display: inline-block; width: 100%">We have already paid you commission of “@if(isset($firstpaymentamount)){{$firstpaymentamount}}@endif”</span>
                    </p>
                      <p style="width: 100%; display: inline-block; margin-bottom: 10px; margin-top: 0;">
                      <span style="display: inline-block; width: 100%">Unfortunately they have cancelled their order with us.</span>
                      </p>
                    <p style="width: 100%; display: inline-block; margin-bottom: 10px; margin-top: 0;">
                      <span style="display: inline-block; width: 100%">This means the 2nd payment of “@if(isset($secondpaymentamount)){{$secondpaymentamount}}@endif” cannot be paid on this occasion.</span>
                    </p>
                    <p style="width: 100%; display: inline-block; margin-bottom: 10px; margin-top: 0;">
